---
name: reel-dafbmgslfl8
description: （草稿）我刚刚发现了一个AI新玩法 來源 IG Reel DafbmGslFL8。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我刚刚发现了一个AI新玩法 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DafbmGslFL8/](https://www.instagram.com/p/DafbmGslFL8/)｜2026-07-07｜
> 123 秒｜23682 views
...
> 我刚刚发现了一个AI新玩法,它不仅能帮你保持场景一致性,还能让你的运镜更流畅。

## 疑似步驟（規則萃取，未經整理）

1. 你现在看到的这些AI画面,都是靠这个玩法生成的。
2. 首先在上一期的资产制作教程里,我们讲到过这种九宫格场景图,用它做参考能很好地稳定视频场景一致性。
3. 首先第一步,先让AI根据你的剧本反推一段场景提示词,模板大家可以用我这个,然后再用GPP一枚张生成,再单独把第九张图提取出来,这样你不仅可以得到一张完整的九宫格场景资产图,还能拿到后面做调度用的俯视空间布局图。
4. 第二步,在这张俯视图上标出人物站位,我们可以用设计软件圈出人物的站位,比如一号位是女主,二号位是男主,或者可以把俯视场景图继续喂给AI,然后输入提示词描述人物的站位,AI就会帮你生成一张带有人物站位关系的俯拍调度图。
5. 接下来是最关键的一步,我们要把人物的移动轨迹用笔画出来,按照之前的经验,我们当然可以用不同颜色的线来控制不同的人物,比如绿色是女主,蓝色是男主,再把这张图传给C等,并在提示词里说明每条颜色代表谁,AI就能更稳定地理解人物走位。
6. 镜头的调度直接决定了最后成片的观感,在这里我就不建议大家还是用手绘的方法了,第一是因为你画的内容不精准,第二是因为你画的内容不专业,最好的办法是把已经画好人物运动路线的俯视图都给AI,让AI根据人物走位反推出镜头的机位,最后我们把这些资产和视频提示词一起传给AI,就可以生成更复杂的打斗、追逐场景,甚至一镜到底的运气。
7. 当然我也把这个技能做成了skill,只要上传给AI你的剧本,它就能自动给你一份俯视图调度的提示词。
