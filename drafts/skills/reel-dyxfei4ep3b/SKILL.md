---
name: reel-dyxfei4ep3b
description: （草稿）我发现最近很多AI创作者很喜欢用时间去换结果 來源 IG Reel DYxFei4Ep3B。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我发现最近很多AI创作者很喜欢用时间去换结果 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DYxFei4Ep3B/](https://www.instagram.com/p/DYxFei4Ep3B/)｜2026-05-25｜
> 107 秒｜866 views
> **分流：** 動作分 7（門檻 3）｜訊號 ['序列詞', '先…再', '教學祈使']
> **語言：** 一律繁體中文輸出。
...
> 我发现最近很多AI创作者很喜欢用时间去换结果。

## 疑似步驟（規則萃取，未經整理）

1. 很多AI创作者会先生成分镜,然后再用分镜图去生视频。
2. 所以我们要先确定一个核心行动,再围绕这个动作做内容,叙事先确定,画面才有方向。
3. 很多AI创作者追求一次生成完整视频,但这样会失去修正的机会。
4. 真正的导演思维是允许不完整,先生成结构段落,哪里弱就单独补一个镜头,比如转折不明显可以补一个反应特写,节奏太平可以补一个禁止空镜。
