---
name: reel-dbqaszuj-g2
description: （草稿）我用C级2.5生成的画面 來源 IG Reel DbqASzUj-g2。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DbqASzUj-g2/](https://www.instagram.com/p/DbqASzUj-g2/)｜2026-08-05｜
> 115 秒｜5021 views
> **分流：** 動作分 3（門檻 3）｜訊號 ['序列詞', '操作動詞']
> **語言：** 一律繁體中文輸出。
...
> 这是我用C级2.5生成的画面,和2.0相比,明显画面更真实,但如果你只看到这个那个太小看它了,因为这次还有三个隐藏升级真的夯爆了,那今天我们不讲那些参数,直接从实测出发告诉你C级2.5到底有什么升级,又有什么进阶玩法,老规矩,资料我都整理好了,大家可以自取,首先第一个就是它一次性变强了,以前用2.0生成长视频,最大的问题不是画面假不假,而是人物场景很难保持一致性,尤其是有多个画面拼接的,但这次2.5不只是把人物保持的更像,它连人物当前的状态都能继续保留下来,比如这段视频,我只上传了一张人物图和这段简单的提示词,从头到尾人物的一致性真的保持非常好,而且一直到最后人物的服装和镜头这些画面的细节也都能一一对应,同时还有一个细节的升级,就是人物质感明显变好了,以前2.0生成人物近景脸上很容易出现偏黄偏灰的色块,人物看起来就会有一种蜡像感,但这次2.5的更新直接升级了这一点,光线和人物会更融合,之前的那种急梦脸现在在2.5也不复存在,第二个,它终于能看得懂动作逻辑了,什么意思呢?

## 疑似步驟（規則萃取，未經整理）

1. 这是我用C级2.5生成的画面,和2.0相比,明显画面更真实,但如果你只看到这个那个太小看它了,因为这次还有三个隐藏升级真的夯爆了,那今天我们不讲那些参数,直接从实测出发告诉你C级2.5到底有什么升级,又有什么进阶玩法,老规矩,资料我都整理好了,大家可以自取,首先第一个就是它一次性变强了,以前用2.0生成长视频,最大的问题不是画面假不假,而是人物场景很难保持一致性,尤其是有多个画面拼接的,但这次2.5不只是把人物保持的更像,它连人物当前的状态都能继续保留下来,比如这段视频,我只上传了一张人物图和这段简单的提示词,从头到尾人物的一致性真的保持非常好,而且一直到最后人物的服装和镜头这些画面的细节也都能一一对应,同时还有一个细节的升级,就是人物质感明显变好了,以前2.0生成人物近景脸上很容易出现偏黄偏灰的色块,人物看起来就会有一种蜡像感,但这次2.5的更新直接升级了这一点,光线和人物会更融合,之前的那种急梦脸现在在2.5也不复存在,第二个,它终于能看得懂动作逻辑了,什么意思呢?
2. 以前我们让AI生成打斗视频,它其实只是在模仿几个动作,人物看起来打得很激烈,但谁在发令AI根本分不清楚,但这次更新之后,明显的能感受到它对于动作打斗的理解更深度了,再加上一些招式参考,整体会看起来更真实,第三个升级就是视频终于可以精准修改了,以前一条视频如果要修改,你只能重新生成,现在我们可以直接暂停画面,标记需要修改的位置,再告诉它具体要改什么,它就能给我们修改好,操作非常简单,这个功能最适合的其实是商业视频,同一条广告我们可以快速更换产品,当然2.5也不是所有内容都提升的很明显,舞蹈和2.0相比,目前差别其实最小,Q版动画虽然整体氛围处理的不错,但人物局部和画风偶尔还是会有点粗糙,所以如果你做的是复杂动作或者TVC广告,这次2.5确实会更好用,但如果只是简单舞蹈或者动画2.0真的很好制作,所以大家还是要好好珍重模型,顺便说一句,2.5真的好贵啊,关注我,带你学习更多AI技巧。
