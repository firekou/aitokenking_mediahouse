---
name: reel-dwxggifk638
description: （草稿）品牌的一种全新身份象征 來源 IG Reel DWxgGIfk638。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DWxgGIfk638/](https://www.instagram.com/p/DWxgGIfk638/)｜2026-04-06｜
> 81 秒｜179 views
> **分流：** 動作分 9（門檻 3）｜訊號 ['步驟序數（第N步）']
> **語言：** 一律繁體中文輸出。
...
> 这是品牌的一种全新身份象征,它不再是以前那种完美无瑕的logo,而是带有人味的不完美。

## 疑似步驟（規則萃取，未經整理）

1. 但实际上,这些并不一定是有人真正在参与创作的,很多你以为很有人味的品牌视觉其实从头到尾都是AI生成的,只不过它被设计成看起来像是被人创作的样子。
2. 第一步,找一张你喜欢构图的任意图案照片,第二步,把它放进图像图的工作流里,第三步,使用这套提示词框架,强制指定一种模拟的实体媒介,比如圆珠笔或者任何符合品牌气质的材质。
