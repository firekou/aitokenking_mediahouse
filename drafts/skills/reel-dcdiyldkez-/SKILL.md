---
name: reel-dcdiyldkez-
description: （草稿）千万别再自己手抽提示词了 來源 IG Reel DcdiYLDkez-。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DcdiYLDkez-/](https://www.instagram.com/p/DcdiYLDkez-/)｜2026-08-25｜
> 103 秒｜6752 views
...
> 千万别再自己手抽提示词了，这是我见过最差的方法。

## 疑似步驟（規則萃取，未經整理）

1. 首先很多人很喜欢一上来就让Codex帮你写提示词。
2. 我们可以去Hinsbyon找几个效果接近的公开案例,把生成结果和原始提示词一起交给Codex学习。
3. 第二步,把你的想法告诉Codex。
4. 这里我推荐Codex的语音输入功能,因为如果用文字去描述的话,不仅浪费时间而且很难想到措辞。
5. 第三步是最重要的一步,有了想法后,我们要让Codex列出素材清单。
6. 最后一步就是生成了,我们在把素材传给Sevens之后,要明确告诉他每份素材的作用。
7. 如果生成的效果你还是不满意,你只要把这段视频下载下来,重新丢给Codex,让他按照你的需求修改就可以了。
