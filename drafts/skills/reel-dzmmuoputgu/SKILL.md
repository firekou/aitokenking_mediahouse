---
name: reel-dzmmuoputgu
description: （草稿）我刚发现了AI一个神奇的弱点 來源 IG Reel DZMMUoPuTGU。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我刚发现了AI一个神奇的弱点 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DZMMUoPuTGU/](https://www.instagram.com/p/DZMMUoPuTGU/)｜2026-06-05｜
> 123 秒｜2631 views
...
> 我刚发现了AI一个神奇的弱点,它能让你的人物动作更高级,你现在看到的画面都是我用这个方法做的,那今天就把这个方法教给你,老规矩,资料都整理好了,有需要的朋友自取,首先你要知道,人物的动作之所以僵硬,其实问题在于你的动作描述太简单了,比如这个画面,我想让角色往前走,大部分人会这么写提示词,但是这样AI只知道人物在走,但不知道他是怎么走的,所以生成的画面多数是这样的,想让动作更高级,你要加的是这三个细节,第一,写清楚人物的步态,同样是走路,一个人可以走得很轻快,也可以走得很沉稳,所以如果你只写走路,AI就不能理解你的情绪,但如果你写清楚人物的步态的话,AI就会知道人物的脚步节奏,身体上下浮动和整体的运动状态,动作自然就会更真实高级,这是我总结的一些步态提示词,大家可以截图保存一下,第二,加上身体联动,在现实生活中,真实的动作一定不是只有一个部位在动的,比如简单的走路,其实你的肩膀和上半身都会一起参与,所以你要在写动作的时候,加入身体的联动,比如肩膀轻微摆动,行走时胯部带动的重心微转,写了这些之后,你的人物才会更高级,第三,加情绪和状态,动作不只是身体运动,它还会受到人物情绪的影响,一个自信的人走路和一个紧张的人走路,身体姿态完全不一样,我们提前告诉AI角色的状态和情绪,这样AI就会分析人物情绪,从而生成一个有状态的人,但高级感其实不止于此,我们可以再往上提升一点,那就是把动作拆成一个完整的动作链,简单来说就是不要只写人物在做什么,而是要写清楚人物是怎么一步一步完成这个动作的,公式很简单,大家可以截图保存一下,比如一个女孩要转身的画面,我们可以根据公式拓展成这样,你看生成的人物动作立马就有了情绪,那如果一个画面里有多个人物呢,这个时候千万不要把所有动作混在一句话里,你要有一个更高级的方法,那就是分角色写,也就是给每个人单独分配动作和权重,谁是主角,谁是配角,每个人分别在做什么都要写清楚,再配合我刚才说的这些,画面就会有主次,记住这三个层级,主角动作要具体,配角动作要简单,背景动作要自然,这样画面里就算有很多人AI也不会乱,所以这几个技巧你学会了吗?

## 疑似步驟（規則萃取，未經整理）

1. 我刚发现了AI一个神奇的弱点,它能让你的人物动作更高级,你现在看到的画面都是我用这个方法做的,那今天就把这个方法教给你,老规矩,资料都整理好了,有需要的朋友自取,首先你要知道,人物的动作之所以僵硬,其实问题在于你的动作描述太简单了,比如这个画面,我想让角色往前走,大部分人会这么写提示词,但是这样AI只知道人物在走,但不知道他是怎么走的,所以生成的画面多数是这样的,想让动作更高级,你要加的是这三个细节,第一,写清楚人物的步态,同样是走路,一个人可以走得很轻快,也可以走得很沉稳,所以如果你只写走路,AI就不能理解你的情绪,但如果你写清楚人物的步态的话,AI就会知道人物的脚步节奏,身体上下浮动和整体的运动状态,动作自然就会更真实高级,这是我总结的一些步态提示词,大家可以截图保存一下,第二,加上身体联动,在现实生活中,真实的动作一定不是只有一个部位在动的,比如简单的走路,其实你的肩膀和上半身都会一起参与,所以你要在写动作的时候,加入身体的联动,比如肩膀轻微摆动,行走时胯部带动的重心微转,写了这些之后,你的人物才会更高级,第三,加情绪和状态,动作不只是身体运动,它还会受到人物情绪的影响,一个自信的人走路和一个紧张的人走路,身体姿态完全不一样,我们提前告诉AI角色的状态和情绪,这样AI就会分析人物情绪,从而生成一个有状态的人,但高级感其实不止于此,我们可以再往上提升一点,那就是把动作拆成一个完整的动作链,简单来说就是不要只写人物在做什么,而是要写清楚人物是怎么一步一步完成这个动作的,公式很简单,大家可以截图保存一下,比如一个女孩要转身的画面,我们可以根据公式拓展成这样,你看生成的人物动作立马就有了情绪,那如果一个画面里有多个人物呢,这个时候千万不要把所有动作混在一句话里,你要有一个更高级的方法,那就是分角色写,也就是给每个人单独分配动作和权重,谁是主角,谁是配角,每个人分别在做什么都要写清楚,再配合我刚才说的这些,画面就会有主次,记住这三个层级,主角动作要具体,配角动作要简单,背景动作要自然,这样画面里就算有很多人AI也不会乱,所以这几个技巧你学会了吗?
