---
name: reel-dbygwfajmqa
description: （草稿）像这种质感的AI短剧 來源 IG Reel DbYGWfajmqa。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DbYGWfajmqa/](https://www.instagram.com/p/DbYGWfajmqa/)｜2026-07-29｜
> 82 秒｜2458 views
> **分流：** 動作分 13（門檻 3）｜訊號 ['步驟序數（第N步）', '序列詞', '操作動詞', '教學祈使', '具體參數']
> **語言：** 一律繁體中文輸出。
...
> 像这种质感的AI短剧,今天我用一分钟教会你,小白也能直接照着做,真的超简单的。

## 疑似步驟（規則萃取，未經整理）

1. 首先我们随便打开一个AI无线画布,第一步,我们要先制作AI人物,因为短距离最容易出错的就是人物,所以我们要先搭建人物资产,这里可以先去网上找一些你喜欢的参考,比如人物的脸型、服装、整体气质,然后把这些参考图分别上传给AI,接着粘贴我这个人物融合提示词,让AI把这些元素再融合在一起,这样你就能得到一个比较完整的故事主角,接着把这个人物下载下来传给AI,让AI根据这个人物的长相、气质和身份,帮我们写一段适合他的短剧剧本,这里一定不要让AI随便写,而是要让他围绕人物特征去写,这样剧情和画面才会统一,写完剧本之后再让AI根据剧情,反推每一场戏需要的场景提示词,这些就会变成我们的场景资产,最后我们让AI把剧本做成分镜,每15秒给我们一段提示词,然后再把这些全部上传给Ceden,就能得到这种原创的AI古风短剧了,只要这个流程跑通,小白也能做出很像样的AI短剧。
