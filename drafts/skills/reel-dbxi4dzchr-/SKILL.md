---
name: reel-dbxi4dzchr-
description: （草稿）你在样视频之所以假 來源 IG Reel DbXI4DzCHr_。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DbXI4DzCHr_/](https://www.instagram.com/p/DbXI4DzCHr_/)｜2026-07-29｜
> 100 秒｜4111 views
...
> 你在样视频之所以假,可能并不是你的提示词写错了,而是模型没选对。

## 疑似步驟（規則萃取，未經整理）

1. 首先先说结论,可怜和Sedence其实都能很好地生成AI视频,甚至有些情况下可怜的效果会更好一些。
2. 那放到实战中来讲,这是它更适合单图生视频,所以无论你是做TVC广告还是品牌短片,在分镜确定的情况下,同样的提示词可怜生成的视频效果会更好。
3. 最重要的是,它生成的人物没有其他模型的假人感,而且次可以更便宜。
4. 所以如果你已经完成了剧本分镜,只差翻版一张分镜生成成视频,那这时候可怜会更好。
5. 最后我再讲几个大家在使用中可能会遇到的坑。
6. 第一个,可怜特别依赖首真质量,如果首真有问题,它生成的画面会很糟糕。
7. 最后总结一下,分镜完整需要稳定和细节就用可怜,只有方向需要AI补充镜头就用Sedence。
