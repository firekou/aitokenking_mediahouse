---
name: reel-dawiekvidyb
description: （草稿）同样是AI短片 來源 IG Reel DawieKViDyb。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DawieKViDyb/](https://www.instagram.com/p/DawieKViDyb/)｜2026-07-14｜
> 126 秒｜5194 views
...
> 同样是AI短片,为什么别人的视频剧情紧凑,画面干净,把你的去联疫苗都看不下去?

## 疑似步驟（規則萃取，未經整理）

1. 首先一个好的剧本不仅只有剧情,它至少还要包含这五个部分。
2. 首先要让AI帮我们把这个点子打开,先拓展一下故事的想象力。
3. 那第二步是给AI一个参考方向。
4. 我们可以直接把剧本交给AI,让他分别从人物身份,动作,道具,声音和镜头五个方向,各设计几种不同的反转,然后挑出最适合画面表现的一种,这样你的剧本就会更有吸引力。
5. 最后一步,当AI发散多的走向,我们可以让他围绕这个点子,生成十个不同的剧情走向,然后再从里面筛选最有看点的版本。
6. 当然,如果你不想学这么多,你也可以直接用我这个导演skill,只需要输入你的一个点子,他就会按照刚才的逻辑引导你做选择,最后给你一段完整的剧本。
