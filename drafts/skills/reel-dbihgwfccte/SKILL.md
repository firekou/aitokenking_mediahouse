---
name: reel-dbihgwfccte
description: （草稿）视频没有创意今天教你三个可以直接套用的AI开展让你不会提词也能做出这样的效果 來源 IG Reel DbIhgwfCCtE。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 视频没有创意今天教你三个可以直接套用的AI开展让你不会提词也能做出这样的效果 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DbIhgwfCCtE/](https://www.instagram.com/p/DbIhgwfCCtE/)｜2026-07-23｜
> 98 秒｜1484 views
...
> 视频没有创意今天教你三个可以直接套用的AI开展让你不会提词也能做出这样的效果首先向开头的这种效果去收一个专业术语叫非常规入画你最想做这种效果可能还要拍绿幕做抠想但现在用AI首尾针几步就能完成你只需要在这个AI模板上传你的照片然后点击生成AI就会自动替换视频里的人物做出这样的效果所以如果你没有灵感你可以优先试试这个第二个动态遮罩那正常情况下呢白墙只是一幅画面内的背景但如果你想让它动起来画面就会变得非常有意思你还可以把视频的标题写在上面当然如果你要卖货也可以用这个方法制作方法很简单你只需要拍摄一张带有墙面的照片上传给AI然后粘贴我这段题词点击生成后AI就会自动补全白墙移动的过程最后把标题产品或者卖点跟踪到白墙上就好那第三个呢简单来讲就是你可以把镜头放在猫眼或者门洞里画面露得越少大家反而对你更有兴趣我们只要把你的视频加上这段题词就能生成余验视角的镜头了这时候我们就可以把你的标题放在周围的黑色区域最后呢再进去一张视频的画面当做手针把原来正常的画面当做尾针点击生成一个猫眼开场就完成了这样既完成了信息展示又完成了一次非常自然的转场那这些AI套路呢我都做成模板大家需要的话可以找我拿所以记住这三个思路不用复杂提词也能做出属于你自己的创意设计

## 疑似步驟（規則萃取，未經整理）

1. 视频没有创意今天教你三个可以直接套用的AI开展让你不会提词也能做出这样的效果首先向开头的这种效果去收一个专业术语叫非常规入画你最想做这种效果可能还要拍绿幕做抠想但现在用AI首尾针几步就能完成你只需要在这个AI模板上传你的照片然后点击生成AI就会自动替换视频里的人物做出这样的效果所以如果你没有灵感你可以优先试试这个第二个动态遮罩那正常情况下呢白墙只是一幅画面内的背景但如果你想让它动起来画面就会变得非常有意思你还可以把视频的标题写在上面当然如果你要卖货也可以用这个方法制作方法很简单你只需要拍摄一张带有墙面的照片上传给AI然后粘贴我这段题词点击生成后AI就会自动补全白墙移动的过程最后把标题产品或者卖点跟踪到白墙上就好那第三个呢简单来讲就是你可以把镜头放在猫眼或者门洞里画面露得越少大家反而对你更有兴趣我们只要把你的视频加上这段题词就能生成余验视角的镜头了这时候我们就可以把你的标题放在周围的黑色区域最后呢再进去一张视频的画面当做手针把原来正常的画面当做尾针点击生成一个猫眼开场就完成了这样既完成了信息展示又完成了一次非常自然的转场那这些AI套路呢我都做成模板大家需要的话可以找我拿所以记住这三个思路不用复杂提词也能做出属于你自己的创意设计
