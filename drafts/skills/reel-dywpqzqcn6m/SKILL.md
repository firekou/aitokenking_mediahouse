---
name: reel-dywpqzqcn6m
description: （草稿）我发现90%的人保持人物一致性的做法是先用AI生一张人物 來源 IG Reel DYwpqZQCN6m。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我发现90%的人保持人物一致性的做法是先用AI生一张人物 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DYwpqZQCN6m/](https://www.instagram.com/p/DYwpqZQCN6m/)｜2026-05-25｜
> 93 秒｜5373 views
...
> 我发现90%的人保持人物一致性的做法是先用AI生一张人物，然后再把这张图当成参考来生视频，这是完全错误的，因为在视频生成里，参考图并不是参考人物，它只是一个风格与结构的弱约束。

## 疑似步驟（規則萃取，未經整理）

1. 我发现90%的人保持人物一致性的做法是先用AI生一张人物，然后再把这张图当成参考来生视频，这是完全错误的，因为在视频生成里，参考图并不是参考人物，它只是一个风格与结构的弱约束。
2. 很多人在生成的时候喜欢把人物和场景一起生成，这样的做法只会加大保持一致性的难度，因为在生成视频时人物和场景是一起参与变化的，场景一变，人物就会被当成画面的一部分重新生成，这就会导致人物不一致。
3. 所以我们要做的是把人物和场景拆开来，先生成人物的四视图，让AI多角度地理解你的角色形象，这样你的人物才能变成一个稳定可复用的对象。
4. 正确做法是先让人物完成指定动作，再和目标场景做融图，最后用首尾真身视频。
