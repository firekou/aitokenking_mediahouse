---
name: reel-dzadnljjdsq
description: （草稿）我发现AI最难的并不是生图 來源 IG Reel DZADNlJjdsq。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我发现AI最难的并不是生图 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DZADNlJjdsq/](https://www.instagram.com/p/DZADNlJjdsq/)｜2026-05-31｜
> 102 秒｜2377 views
> **分流：** 動作分 3（門檻 3）｜訊號 ['操作動詞', '教學祈使']
> **語言：** 一律繁體中文輸出。
...
> 我发现AI最难的并不是生图,而是怎么控制人物的声音。

## 疑似步驟（規則萃取，未經整理）

1. AI其实是能做好音色区分的,你看这些画面,其实都是我用AI生成的。
2. 我一般会有一个声音公式,大家可以截图保存一下。
