---
name: reel-dyiiuyyags5
description: （草稿）我发现很多人在写提示词的时候都会忽略一点 來源 IG Reel DYiiUYYAGS5。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我发现很多人在写提示词的时候都会忽略一点 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DYiiUYYAGS5/](https://www.instagram.com/p/DYiiUYYAGS5/)｜2026-05-20｜
> 81 秒｜368 views
...
> 我发现很多人在写提示词的时候都会忽略一点,那就是提示词语序。

## 疑似步驟（規則萃取，未經整理）

1. 首先,我们要把主体词放前面,前置主体词可以让AI先把重点放在你最关心的元素上。
2. 第二,我们要把光影词放中段,AI在渲染光影时会参考前面已经生成的主体。
