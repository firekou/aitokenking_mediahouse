---
name: reel-dyua91zkzug
description: （草稿）我发现很多人对电影感有很大的误区 來源 IG Reel DYuA91zkZUg。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我发现很多人对电影感有很大的误区 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DYuA91zkZUg/](https://www.instagram.com/p/DYuA91zkZUg/)｜2026-05-24｜
> 92 秒｜408 views
> **分流：** 動作分 11（門檻 3）｜訊號 ['步驟序數（第N步）', '序列詞', '先…再', '教學祈使']
> **語言：** 一律繁體中文輸出。
...
> 我发现很多人对电影感有很大的误区,就是大多数人以为只要加几个风格词画面就会有电影感。

## 疑似步驟（規則萃取，未經整理）

1. 方法一,先写摄影约束,再写美学风格。
2. 我们要在生图之前先明确这三类信息,镜头类型,拍摄距离,光线结构,把这些摄影约束写在风格词前面,AI就能按照参数来生成,画面自然有电影感。
3. 电影镜头不是一步到位的,而是先成立一个镜头再往上叠信息。
4. 正确顺序是第一轮只升程构图和光线,然后再加入人物的动作状态,最后才加风格,因为模型在第一步就锁定了拍摄解法。
