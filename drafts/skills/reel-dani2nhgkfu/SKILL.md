---
name: reel-dani2nhgkfu
description: （草稿）朋友都是C-Dance 來源 IG Reel DanI2nhgKfu。 逐字稿提到的工具（⚠️ 未經畫面確認）：Dance。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DanI2nhgKfu/](https://www.instagram.com/p/DanI2nhgKfu/)｜2026-07-10｜
> 124 秒｜3247 views
> **分流：** 動作分 5（門檻 3）｜訊號 ['序列詞', '先…再', '具體參數']
> **語言：** 一律繁體中文輸出。
...
1. 把你的劝一眼讲,这90%的原因是因为你的提示词结构错了那今天我就用这段AI情绪短片手把手教你C-Dance提示词到底应该怎么写老规矩,模版和案例我都整理好了有需要的朋友可以自取在教学开始之前先讲一个前提就是你要先准备好你的资产再写提示词这些是C-Dance生成视频的基础不会的朋友可以看我这期内容资产准备好以后我们才进入到提示词环节首先一段能稳定生成的视频提示词其实要拆成两层第一层是全局设定它负责固定整部片子的基调比如人物长什么样,场景是什么风格,镜头光线和色调又是怎么样的那这些内容可以保持你的画面的稳定如果你的视频要分段生成这段走设定就可以压缩成一个前缀放在每一段提示词前面但真正决定视频可不可控的是第二层也就是单镜头指令这里是很多人阵容一写错的地方一段真正能出片的C-Dance提示词其实是从外道里写的最外面的是你的景别中间是你的画面描述这里面才是画面发生的内容比如这段剧情很多人会写成这样虽然这段话故事是完整的但对C-Dance来说信息实在太多了里面整整包含了五个镜头正确的写法是把它拆出来比如第一个镜头是什么第二个镜头又是什么这才是一段真正能执行的提示词那一段提示词的内容到底要写什么呢其实只要记住这三件事就可以了第一镜头从哪里开始第二画面里谁是主角第三他在做什么这里再告诉大家一个小技巧就是你可以用Hard Cut来控制画面节奏当然还有这些专业术语大家都可以拿去用比如这个镜头我不想再拍文件了我们就可以在提示词里写Hard Cut它就会重新开始下一段把复杂运镜拆开反而会比一条塞满所有运镜更有电影感最后还有一个很多人会忽略的点就是每一镜一定要锁住结尾的画面什么意思比如这一段的结尾是女主和男主对视那下一段视频就可以从男主台演的近景开始这样每一段画面之间就都有了关系你的视频也就能越做越长只要你学会把故事拆成镜头AI就不再是在抽卡而是真的在按照你的分镜拍片当然我也把这套提示词模板整理成了Skill把剧本和人物资产传进去它就能直接帮你拆出每15秒的视频提示词所以这个方法你学会了吗

## 逐字稿提到的工具

| 名稱 | 證據強度 | 說明 |
|---|---|---|
| `Dance` | ⚠️ **E5** | 逐字稿聽寫，**未經畫面確認**。實測顯示同一工具可能有多種錯拼 |
