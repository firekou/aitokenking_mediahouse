---
name: reel-db2-p47cow5
description: （草稿）教大家怎么用AI做样机并嵌入logo展示 來源 IG Reel Db2_P47CoW5。 逐字稿提到的工具（⚠️ 未經畫面確認）：Link。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 教大家怎么用AI做样机并嵌入logo展示 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/Db2_P47CoW5/](https://www.instagram.com/p/Db2_P47CoW5/)｜2026-08-10｜
> 41 秒｜724 views
...
> 今天教大家怎么用AI做样机并嵌入logo展示，真的超简单的。

## 疑似步驟（規則萃取，未經整理）

1. 首先我们打开Lipple Link，在搜索栏里我们搜索品牌这两个字，然后我们找到这个卢老师的样机工作流。
2. 目前来讲这个工作流比较火热，接下来是重要的一步，我们直接滑到下面的反图区，我们在这里面选择一个自己喜欢的，然后点击右下角的话同款，这样我们就得到了这幅样机的提示词了，然后我们直接在上面做修改，把自己想要的logo或者品牌颜色替换上去，点击生成就可以等待生成了。

## 逐字稿提到的工具

| 名稱 | 證據強度 | 說明 |
|---|---|---|
| `Link` | ⚠️ **E5** | 逐字稿聽寫，**未經畫面確認**。實測顯示同一工具可能有多種錯拼 |
