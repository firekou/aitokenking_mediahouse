---
name: reel-dzz7qfwitnp
description: （草稿）我发现很多AI视频之所以像电影并不是因为它们的提示词有多复杂而是它们会用空镜 來源 IG Reel DZZ7QfWiTNp。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
# 我发现很多AI视频之所以像电影并不是因为它们的提示词有多复杂而是它们会用空镜 — ⚠️ 自動草稿

> **狀態：DRAFT。這不是一支可以直接用的 skill。**
> 它由規則從逐字稿萃取產生，**沒有經過人整理、沒有經過實測**。
> 晉升到 `skills/` 是人的動作，見檔尾《晉升前必須做的四件事》。
>
> **來源：** [https://www.instagram.com/p/DZZ7QfWiTNp/](https://www.instagram.com/p/DZZ7QfWiTNp/)｜2026-06-10｜
> 150 秒｜2104 views
...
> 我发现很多AI视频之所以像电影并不是因为它们的提示词有多复杂而是它们会用空镜讲故事比如最近很火的这三部片子无一例外都用了很多空镜去铺垫情绪而这种对节奏的把控恰恰就是你和大神之间的差距那今天这个视频我们从基础开始教你如何正确生成空镜又应该如何使用老规矩资料我都整理好了有需要的朋友可以自取首先空镜并不是我们平常理解的风景画面像摇晃的烛火掉落在地上的发簪或者门外突然停下的脚步其实也可以承担空镜的作用在电影叙事里这叫插入镜头它们虽然没有正面拍摄主角却一直在替人物讲故事而空镜主要有三个作用第一交代故事发生的环境第二控制视频的节奏和呼吸感第三代替人物表达情绪那我们要怎么去生成一个合理的空镜呢首先空镜不是随便生成一个风景它必须和剧情有关这里教大家一个最简单的方法就是从剧本里提取三个东西分别是环境、道具还有情绪比如这场发生在雨夜的画面剧情是女主站在等一个不会回来的人如果你只盯着人物本身的情绪那你的画面就会很单调但是如果你按照我刚才的方法分别生成环境空镜、道具空镜还有情绪空镜再把它们连在一起整体的画面会更有节奏已经热过三回了不是她这里有一个你要注意就是做视频不要太急很多人一上来就想把情绪一下全部交给观众但是这样会显得很刻意适当流出一到两秒给空镜这些能够让观众消化你的内容那一个合理的空镜至少要写清楚这种的信息比如这段空镜提示词你可以按照我的方法拓展成这样这样生成出来的镜头才有叙事但是最简单的方法还是在做故事版的时候让AI直接帮我们写这样我们就不用花很多时间再写提示词上了那空镜生成以后应该放在哪里呢大家记住三个位置第一个一场戏开始之前用环境空镜快速交代时间和地点第二个人物说完重要台词以后加入道具或者环境空镜给观众流出消化情绪的时间第三个两场戏转换的时候用空镜完成过渡避免画面直接跳到下一个场景这也是做AI长视频的方法之一但空镜也不是越多越好正常情况下一个空镜控制在一到三秒只放在情绪需要停顿的位置这期用到的空镜提示词公式以及不同情绪的空镜案例我都整理好了大家可以直接拿去套用所以这个空镜法你学会了吗小错了海棠开了

## 疑似步驟（規則萃取，未經整理）

1. 我发现很多AI视频之所以像电影并不是因为它们的提示词有多复杂而是它们会用空镜讲故事比如最近很火的这三部片子无一例外都用了很多空镜去铺垫情绪而这种对节奏的把控恰恰就是你和大神之间的差距那今天这个视频我们从基础开始教你如何正确生成空镜又应该如何使用老规矩资料我都整理好了有需要的朋友可以自取首先空镜并不是我们平常理解的风景画面像摇晃的烛火掉落在地上的发簪或者门外突然停下的脚步其实也可以承担空镜的作用在电影叙事里这叫插入镜头它们虽然没有正面拍摄主角却一直在替人物讲故事而空镜主要有三个作用第一交代故事发生的环境第二控制视频的节奏和呼吸感第三代替人物表达情绪那我们要怎么去生成一个合理的空镜呢首先空镜不是随便生成一个风景它必须和剧情有关这里教大家一个最简单的方法就是从剧本里提取三个东西分别是环境、道具还有情绪比如这场发生在雨夜的画面剧情是女主站在等一个不会回来的人如果你只盯着人物本身的情绪那你的画面就会很单调但是如果你按照我刚才的方法分别生成环境空镜、道具空镜还有情绪空镜再把它们连在一起整体的画面会更有节奏已经热过三回了不是她这里有一个你要注意就是做视频不要太急很多人一上来就想把情绪一下全部交给观众但是这样会显得很刻意适当流出一到两秒给空镜这些能够让观众消化你的内容那一个合理的空镜至少要写清楚这种的信息比如这段空镜提示词你可以按照我的方法拓展成这样这样生成出来的镜头才有叙事但是最简单的方法还是在做故事版的时候让AI直接帮我们写这样我们就不用花很多时间再写提示词上了那空镜生成以后应该放在哪里呢大家记住三个位置第一个一场戏开始之前用环境空镜快速交代时间和地点第二个人物说完重要台词以后加入道具或者环境空镜给观众流出消化情绪的时间第三个两场戏转换的时候用空镜完成过渡避免画面直接跳到下一个场景这也是做AI长视频的方法之一但空镜也不是越多越好正常情况下一个空镜控制在一到三秒只放在情绪需要停顿的位置这期用到的空镜提示词公式以及不同情绪的空镜案例我都整理好了大家可以直接拿去套用所以这个空镜法你学会了吗小错了海棠开了
