---
name: reel-dyxe8sfddge
description: （草稿）这些画面之所以不像AI 來源 IG Reel DYxE8sfDdGe。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DYxE8sfDdGe/](https://www.instagram.com/p/DYxE8sfDdGe/)｜2026-05-25｜
> 111 秒｜2168 views
> **分流：** 動作分 5（門檻 3）｜訊號 ['步驟序數（第N步）', '序列詞', '教學祈使']
> **語言：** 一律繁體中文輸出。
...
> 这些画面之所以不像AI,不是因为我的提示词足够长,而是因为写得足够短。

## 疑似步驟（規則萃取，未經整理）

1. 虽然可灵3.0和吉末C-DANCE2这种模型已经能用很少的词生成很真实的画面,但情绪词本身还是不会成为真正的控制信息。
2. AI会拆解电影感,可能包含了画面组合,然后从大量可能性里给你一个还不错的结果。
3. 所以第一步我们要剪掉这些情绪词,用能被保留的具体信息去体现,这样画面才能得到精准控制。
