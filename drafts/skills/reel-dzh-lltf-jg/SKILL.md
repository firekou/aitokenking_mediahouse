---
name: reel-dzh-lltf-jg
description: （草稿）为了推掉这门亲事 來源 IG Reel DZH_LlTF_JG。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
metadata:
  ...
  mediahouse-source-shortcode: "DZH_LlTF_JG"
...
>
> **來源：** [https://www.instagram.com/p/DZH_LlTF_JG/](https://www.instagram.com/p/DZH_LlTF_JG/)｜2026-06-03｜
> 149 秒｜5869 views
> **分流：** 動作分 11（門檻 3）｜訊號 ['步驟序數（第N步）', '序列詞', '教學祈使', '具體參數']
> **語言：** 一律繁體中文輸出。
...
> 为了推掉这门亲事，本小姐装了整整三个月的哑巴。

## 疑似步驟（規則萃取，未經整理）

1. 很多人的提示词已经写得很好了，但生成的视频还是一眼假。
2. 这大概率是因为你的第一步就做错了。
3. 首先如果把一部AI短剧拆开来看，其实决定它高级感的就这三件事。
4. 所以我们AI短剧的第一步不是直接生成视频，而是先搭建人物资产。
5. 所以我建议大家不要只生成一张人物图,因为一张图的信息量是不够的,我们可以把这三张拆开来生成,最后再融合在一起。
6. 比较稳的做法是先做一张人物脸部三视图,这里面包含了人物面部妆造和发饰,提示词可以用我这个,然后再做一张全身三视图去固定人物的服装结构,尤其是古风短剧,人物身上的信息量非常多,任何一个地方不稳定画面都会变得很廉价,所以这个资产是非常重要的,这里有一个注意的点,就是不要一开始就追求特别复杂的造型,很多人喜欢给人物堆特别多头饰,看起来很华丽,但实际生成视频的时候非常容易崩,真正高级的短剧人物不是元素越多越好,而是特征要清晰,比如女主可以固定三个记忆点,她的高炉顶黑发,金色古风头饰和浅色系长裙,男主也同样可以固定这三个记忆点,只要把这些核心特征稳定住,观众就会觉得这是同一个人,我这整理了100多个角色发饰和妆造,大家可以自取,那光效应该怎么做呢?
7. 这张七亿百万人看过的故事版其实讲的就是这个,核心要素就是保持一个故事版在15秒之内,画面要干净简单,再加上人物版和预想效果图,你的分镜就不会很卡,那剧本其实我们完全可以让AI帮我们写一个,当然如果你有想法也可以自己写,最后总结一下,这种S加级别的AI短剧不要迷信提示词,我们要换个思路去制作,所以这个方法你学会了吗?
