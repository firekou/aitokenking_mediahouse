---
name: reel-dbhqxeugvkv
description: （草稿）变化两年学广告 來源 IG Reel DbHqXeUgvkv。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DbHqXeUgvkv/](https://www.instagram.com/p/DbHqXeUgvkv/)｜2026-07-23｜
> 99 秒｜6129 views
...
> 变化两年学广告,我两分钟教你用AI直出这种效果。

## 疑似步驟（規則萃取，未經整理）

1. 首先你要知道,一条有创意的品牌短片并不是给产品随便加一点特效就行,而是要把产品最核心的功能变成一个故事。
2. 第一步,把产品图先传给AI,让它先按照实物顺序猜出所有能被看到的变化,再从这些变化里挑出一个最适合拍成画面的功能。
3. 第二步,我要这束光设计完整路线,它从哪里出发,一次照到什么物体,每碰到一个物体空间又会发生什么变化,这样我们就能得到一套首尾连贯的分镜。
4. 第三步,再让AI分别生成画面,这里的提示词只需要写清楚四件事,光从哪里来,往哪里动,照到了什么,这个空间发生了什么变化,每个镜头只改变一个空间AI反而更容易执行,这样既交代了产品,你把前面的所有画面收了回来,这里有一个重点,每个镜头不要在一条提示词里同时写很多动作,动作越多AI越容易失控,最后再把资产和分镜图一起上传去生成视频,你就能得到这样一条有逻辑的创意品牌短片,所以品牌短片真正的高级感不是加入多少特效,而是让产品本来的功能变成一个故事,这个故事才是创意的来源,那这个方法你学会了吗?
