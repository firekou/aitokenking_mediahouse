---
name: reel-dy4ugxcudqe
description: （草稿）这些AI角色之所以高级 來源 IG Reel DY4UgXcuDQE。 當使用者問到這支影片的做法、或想把它變成可執行流程時使用。⚠️ 這是自動產生的草稿，尚未經人工整理與實測，不得作為效果承諾依據。
license: MIT
...
>
> **來源：** [https://www.instagram.com/p/DY4UgXcuDQE/](https://www.instagram.com/p/DY4UgXcuDQE/)｜2026-05-28｜
> 118 秒｜1160 views
> **分流：** 動作分 4（門檻 3）｜訊號 ['序列詞', '操作動詞', '教學祈使']
> **語言：** 一律繁體中文輸出。
...
> 这些AI角色之所以高级,其实靠的并不是他们的五官,而是装造。

## 疑似步驟（規則萃取，未經整理）

1. 首先我们要知道男性角色和女性角色的装造需求是不一样的。
2. 如果你不知道对应装造的写法,可以截图保存我这几张。
3. 接下来我们说女性角色,女性角色需要的会更多,不只是服装状态,我们更要注重的是面部妆容和发饰。
